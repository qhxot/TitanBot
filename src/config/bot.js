...
export const botConfig = {
  ...
  embeds: {
    colors: {
      primary: "#336699", secondary: "#2F3136",
      success: "#57F287", error: "#ED4245", warning: "#FEE75C", info: "#3498DB",
      light: "#FFFFFF", dark: "#202225", gray: "#99AAB5",
      blurple: "#5865F2", green: "#57F287", yellow: "#FEE75C", fuchsia: "#EB459E", red: "#ED4245", black: "#000000",
      giveaway: { active: "#57F287", ended: "#ED4245" },
      ticket: { open: "#57F287", claimed: "#FAA61A", closed: "#ED4245", pending: "#99AAB5" },
      economy: "#F1C40F", birthday: "#E91E63", moderation: "#9B59B6",
  ...
  userInfo: {
    commands: {
      pfp: { enabled: true, cooldown: 3, description: "Mostra l'avatar di un utente" },
      fm: { enabled: true, cooldown: 3, description: "Mostra cosa sta ascoltando un utente" },
      userinfo: { enabled: true, cooldown: 5, description: "Mostra info complete di un utente" }
    },
    avatarFormats: { png: true, jpg: true, webp: true, gif: true },
    maxAvatarSize: 4096,
